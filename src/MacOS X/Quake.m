...
- (void) fireFrameTimer: (NSNotification *) theNotification
{
 ...
 //   IN_SetKeyboardRepeatEnabled (NO);
    ...
    Con_Printf ("\n€‚\n");
    Con_Printf ("QuakeWorld for MacOS X -- Version %0.2f\n", MACOSX_VERSION);
    Con_Printf ("    Ported by: awefruitz of dojo\n");
    ...
    Con_Printf ("\n€‚\n\n");
    Con_Printf (" MacQuake Ported by: awe\n");
	Con_Printf (" ProQuake Ported by: woods\n\n");
    Con_Printf (" http://www.fruitz-of-dojo.de\n");
    Con_Printf ("\n€‚\n\n");
