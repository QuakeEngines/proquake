...
//	{
//		EmptyClipboard();
//		clipbuffer = GlobalAlloc(GMEM_DDESHARE, sizeof(str)-1);
...
//		CloseClipboard(); */
//		Con_Printf ("Time written to clipboard", str);
//	}
//	else
//	{
//		Con_Printf ("Clipboard access failed", str);
//	}
//
//#endif
//*/
...
//	Cmd_AddCommand ("concopy", Con_Copy_f); // Baker 3.85 - copy console to clipboard
#endif
